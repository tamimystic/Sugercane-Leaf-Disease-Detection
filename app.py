    ...
    with gr.Row():
        gr.Markdown(
            ...
            <div style="text-align: center; max-width: 900px; margin: 0 auto; padding: 40px 0;">
                ...
                <p class="header-desc">Upload an image of a sugarcane leaf to instantly detect health conditions using Deep Learning. The system also provides Explainable AI (XAI) visuals like Grad-CAM++ and LIME to show exactly why it made its decision. <br><br><span style="color: #fbbf24; font-size: 1rem; font-weight: 600;">(Note: If you encounter an error, please ensure you have created an account and are logged into Hugging Face to use this platform.)</span></p>
            </div>
            """
        )
